...
const (
	Dimension_K1M   Dimension = 0 // 1分钟
	Dimension_K5M   Dimension = 1 // 5分钟
	Dimension_K15M  Dimension = 2
	Dimension_K30M  Dimension = 3
	Dimension_K1H   Dimension = 4 // 1小时
	Dimension_K4H   Dimension = 5
	Dimension_K12H  Dimension = 6
	Dimension_K24H  Dimension = 7
	Dimension_K3D   Dimension = 8 // 3天
	Dimension_KWEEK Dimension = 9 // 1周
)
...
type NewPairOperation int32

const (
	NewPairOperation_UPDATE NewPairOperation = 0
	NewPairOperation_ADD    NewPairOperation = 1
)

// Enum value maps for NewPairOperation.
var (
	NewPairOperation_name = map[int32]string{
		0: "UPDATE",
		1: "ADD",
	}
	NewPairOperation_value = map[string]int32{
		"UPDATE": 0,
		"ADD":    1,
	}
)

func (x NewPairOperation) Enum() *NewPairOperation {
	p := new(NewPairOperation)
	*p = x
	return p
}

func (x NewPairOperation) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (NewPairOperation) Descriptor() protoreflect.EnumDescriptor {
	return file_engine_engine_proto_enumTypes[3].Descriptor()
}

func (NewPairOperation) Type() protoreflect.EnumType {
	return &file_engine_engine_proto_enumTypes[3]
}

func (x NewPairOperation) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use NewPairOperation.Descriptor instead.
func (NewPairOperation) EnumDescriptor() ([]byte, []int) {
...
type KLine struct {
	...
	Amount    float64   `protobuf:"fixed64,8,opt,name=amount,proto3" json:"amount,omitempty"`        //成交数量
	Volume    float64   `protobuf:"fixed64,9,opt,name=volume,proto3" json:"volume,omitempty"`        //成交价值
	Increase  float64   `protobuf:"fixed64,10,opt,name=increase,proto3" json:"increase,omitempty"`   //增幅
	Amplitude float64   `protobuf:"fixed64,11,opt,name=amplitude,proto3" json:"amplitude,omitempty"` // 振幅
...
type SubscribeKlineRequest struct {
	...
	Dex              *Dex      `protobuf:"bytes,4,opt,name=dex,proto3" json:"dex,omitempty"` // 交易所信息
...
func (x *SubscribeKlineRequest) GetBaseTokenAddress() string {
	if x != nil {
...
type Trade struct {
	...
	BaseUrl      string  `protobuf:"bytes,8,opt,name=base_url,json=baseUrl,proto3" json:"base_url,omitempty"` // base_url + tx_hash是一个跳转链接
...
func (x *Trade) GetBaseUrl() string {
	if x != nil {
		return x.BaseUrl
	}
	return ""
...
func (x *Trade) GetTokenAddress() string {
	if x != nil {
		return x.TokenAddress
	}
	return ""
...
func (x *SubscribeTradeRequest) GetBaseTokenAddress() string {
	if x != nil {
		return x.BaseTokenAddress
	}
	return ""
...
type SubscribeNewPairResponse struct {
	...
	Operation    NewPairOperation               `protobuf:"varint,4,opt,name=operation,proto3,enum=engine.api.NewPairOperation" json:"operation,omitempty"`
	NewPairCount int64                          `protobuf:"varint,5,opt,name=new_pair_count,json=newPairCount,proto3" json:"new_pair_count,omitempty"`
}
...
func (x *SubscribeNewPairResponse) GetOperation() NewPairOperation {
	if x != nil {
		return x.Operation
	}
	return NewPairOperation_UPDATE
}
...
type GetKlineHistoryRequest struct {
	...
	BaseAddress string    `protobuf:"bytes,7,opt,name=base_address,json=baseAddress,proto3" json:"base_address,omitempty"`
}
...
func (x *GetKlineHistoryRequest) GetBaseAddress() string {
	if x != nil {
...
type BasicInfo struct {
	...
	TokenBaseUrl        string  `protobuf:"bytes,2,opt,name=token_base_url,json=tokenBaseUrl,proto3" json:"token_base_url,omitempty"`
	PairContractAddress string  `protobuf:"bytes,3,opt,name=pair_contract_address,json=pairContractAddress,proto3" json:"pair_contract_address,omitempty"`
	PairBaseUrl         string  `protobuf:"bytes,4,opt,name=pair_base_url,json=pairBaseUrl,proto3" json:"pair_base_url,omitempty"`
	...
	Holders             int64   `protobuf:"varint,7,opt,name=holders,proto3" json:"holders,omitempty"`
	Dex                 *Dex    `protobuf:"bytes,8,opt,name=dex,proto3" json:"dex,omitempty"`
	BaseToken_Name      string  `protobuf:"bytes,9,opt,name=base_token_Name,json=baseTokenName,proto3" json:"base_token_Name,omitempty"`
}
...
func (x *BasicInfo) GetTokenBaseUrl() string {
	if x != nil {
		return x.TokenBaseUrl
	}
	return ""
}
...
func (x *BasicInfo) GetPairBaseUrl() string {
	if x != nil {
		return x.PairBaseUrl
	}
	return ""
}
...
func (x *BasicInfo) GetTotalTx() int64 {
	if x != nil {
		return x.TotalTx
	}
	return 0
...
func (x *BasicInfo) GetHolders() int64 {
	if x != nil {
		return x.Holders
	}
	return 0
...
func (x *BasicInfo) GetBaseToken_Name() string {
	if x != nil {
		return x.BaseToken_Name
	}
	return ""
}
...
type OnParseBlockTimeRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	CurrentBlockTimeStamp int64 `protobuf:"varint,1,opt,name=current_block_time_stamp,json=currentBlockTimeStamp,proto3" json:"current_block_time_stamp,omitempty"`
}

func (x *OnParseBlockTimeRequest) Reset() {
	*x = OnParseBlockTimeRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *OnParseBlockTimeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OnParseBlockTimeRequest) ProtoMessage() {}

func (x *OnParseBlockTimeRequest) ProtoReflect() protoreflect.Message {
	mi := &file_engine_engine_proto_msgTypes[35]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OnParseBlockTimeRequest.ProtoReflect.Descriptor instead.
func (*OnParseBlockTimeRequest) Descriptor() ([]byte, []int) {
	return file_engine_engine_proto_rawDescGZIP(), []int{35}
}

func (x *OnParseBlockTimeRequest) GetCurrentBlockTimeStamp() int64 {
	if x != nil {
...
type OnParseBlockTimeResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *OnParseBlockTimeResponse) Reset() {
	*x = OnParseBlockTimeResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *OnParseBlockTimeResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OnParseBlockTimeResponse) ProtoMessage() {}

func (x *OnParseBlockTimeResponse) ProtoReflect() protoreflect.Message {
	mi := &file_engine_engine_proto_msgTypes[36]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OnParseBlockTimeResponse.ProtoReflect.Descriptor instead.
func (*OnParseBlockTimeResponse) Descriptor() ([]byte, []int) {
	return file_engine_engine_proto_rawDescGZIP(), []int{36}
}

func (x *OnParseBlockTimeResponse) GetStatus() InternalEngineStatus {
	if x != nil {
		return x.Status
	}
	return InternalEngineStatus_INTERNAL_ENGINE__SUCCESS
...
var file_engine_engine_proto_rawDesc = []byte{
	...
	0x4b, 0x4c, 0x69, 0x6e, 0x65, 0x52, 0x05, 0x6b, 0x6c, 0x69, 0x6e, 0x65, 0x22, 0xdd, 0x01, 0x0a,
	...
	,
	...
	0x06, 0x74, 0x78, 0x48, 0x61, 0x73, 0x68, 0x12, 0x1b, 0x0a, 0x09, 0x70, 0x72, 0x69, 0x63, 0x65,
	0x5f, 0x75, 0x73, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x01, 0x52, 0x08, 0x70, 0x72, 0x69, 0x63,
	0x65, 0x55, 0x73, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x70, 0x72, 0x69, 0x63, 0x65, 0x5f, 0x65, 0x74,
	0x68, 0x18, 0x06, 0x20, 0x01, 0x28, 0x01, 0x52, 0x08, 0x70, 0x72, 0x69, 0x63, 0x65, 0x45, 0x74,
	0x68, 0x12, 0x1f, 0x0a, 0x0b, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65,
	0x18, 0x07, 0x20, 0x01, 0x28, 0x01, 0x52, 0x0a, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x56, 0x61, 0x6c,
	0x75, 0x65, 0x12, 0x19, 0x0a, 0x08, 0x62, 0x61, 0x73, 0x65, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x08,
	...
	,
	...
	0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x62, 0x61,
	0x73, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0xb9,
	0x01, 0x0a, 0x16, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x54, 0x72, 0x61, 0x64,
	...
	0x74, 0x75, 0x73, 0x12, 0x36, 0x0a, 0x0a, 0x74, 0x72, 0x61, 0x64, 0x65, 0x5f, 0x6c, 0x69, 0x73,
	0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65,
	0x2e, 0x61, 0x70, 0x69, 0x2e, 0x54, 0x72, 0x61, 0x64, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x48, 0x00,
	0x52, 0x09, 0x74, 0x72, 0x61, 0x64, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x26, 0x0a, 0x04, 0x70,
	...
	0x69, 0x6e, 0x67, 0x42, 0x05, 0x0a, 0x03, 0x6d, 0x73, 0x67, 0x22, 0xca, 0x02, 0x0a, 0x08, 0x4e,
	0x65, 0x77, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20,
	...
	0x0a, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28,
	...
	,
	...
	,
	...
	0x28, 0x09, 0x52, 0x05, 0x71, 0x75, 0x6f, 0x74, 0x65, 0x12, 0x33, 0x0a, 0x09, 0x64, 0x69, 0x6d,
	0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x15, 0x2e, 0x65,
	0x6e, 0x67, 0x69, 0x6e, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x44, 0x69, 0x6d, 0x65, 0x6e, 0x73,
	0x69, 0x6f, 0x6e, 0x52, 0x09, 0x64, 0x69, 0x6d, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x19,
	0x0a, 0x08, 0x74, 0x73, 0x5f, 0x73, 0x74, 0x61, 0x72, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x07, 0x74, 0x73, 0x53, 0x74, 0x61, 0x72, 0x74, 0x12, 0x15, 0x0a, 0x06, 0x74, 0x73, 0x5f,
	0x65, 0x6e, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x74, 0x73, 0x45, 0x6e, 0x64,
	...
	0x65, 0x73, 0x73, 0x22, 0x89, 0x01, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x4b, 0x6c, 0x69, 0x6e, 0x65,
	...
	,
	...
	0x64, 0x65, 0x78, 0x12, 0x1d, 0x0a, 0x0a, 0x62, 0x61, 0x73, 0x65, 0x5f, 0x74, 0x6f, 0x6b, 0x65,
	0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x62, 0x61, 0x73, 0x65, 0x54, 0x6f, 0x6b,
	0x65, 0x6e, 0x12, 0x2c, 0x0a, 0x12, 0x62, 0x61, 0x73, 0x65, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e,
	...
	,
	...
	0x74, 0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x8a, 0x01, 0x0a, 0x11,
	0x4f, 0x6e, 0x4e, 0x65, 0x77, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18,
	...
	,
	...
	,
	...
	0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x21, 0x0a, 0x03, 0x64, 0x65, 0x78, 0x18, 0x0a,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x2e, 0x61, 0x70,
	0x69, 0x2e, 0x44, 0x65, 0x78, 0x52, 0x03, 0x64, 0x65, 0x78, 0x22, 0x4e, 0x0a, 0x12, 0x4f, 0x6e,
	0x50, 0x61, 0x69, 0x72, 0x53, 0x79, 0x6e, 0x63, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	...
	,
}
...
var file_engine_engine_proto_msgTypes = make([]protoimpl.MessageInfo, 37)
var file_engine_engine_proto_goTypes = []interface{}{
	...
	(NewPairOperation)(0),            // 3: engine.api.NewPairOperation
	(*Dex)(nil),                      // 4: engine.api.Dex
	(*Ping)(nil),                     // 5: engine.api.Ping
	(*Hot)(nil),                      // 6: engine.api.Hot
	(*HotList)(nil),                  // 7: engine.api.HotList
	(*SubscribeHotRequest)(nil),      // 8: engine.api.SubscribeHotRequest
	(*SubscribeHotResponse)(nil),     // 9: engine.api.SubscribeHotResponse
	(*KLine)(nil),                    // 10: engine.api.KLine
	(*KLineList)(nil),                // 11: engine.api.KLineList
	(*SubscribeKlineRequest)(nil),    // 12: engine.api.SubscribeKlineRequest
	(*SubscribeKlineResponse)(nil),   // 13: engine.api.SubscribeKlineResponse
	(*Trade)(nil),                    // 14: engine.api.Trade
	(*TradeList)(nil),                // 15: engine.api.TradeList
	(*SubscribeTradeRequest)(nil),    // 16: engine.api.SubscribeTradeRequest
	(*SubscribeTradeResponse)(nil),   // 17: engine.api.SubscribeTradeResponse
	(*NewToken)(nil),                 // 18: engine.api.NewToken
	(*NewTokenList)(nil),             // 19: engine.api.NewTokenList
	(*SubscribeNewPairRequest)(nil),  // 20: engine.api.SubscribeNewPairRequest
	(*SubscribeNewPairResponse)(nil), // 21: engine.api.SubscribeNewPairResponse
	(*GetNewPairRequest)(nil),        // 22: engine.api.GetNewPairRequest
	(*GetNewPairResponse)(nil),       // 23: engine.api.GetNewPairResponse
	(*GetKlineHistoryRequest)(nil),   // 24: engine.api.GetKlineHistoryRequest
	(*GetKlineHistoryResponse)(nil),  // 25: engine.api.GetKlineHistoryResponse
	(*BasicInfo)(nil),                // 26: engine.api.BasicInfo
	(*GetBasicInfoRequest)(nil),      // 27: engine.api.GetBasicInfoRequest
	(*GetBasicInfoResponse)(nil),     // 28: engine.api.GetBasicInfoResponse
	(*OnNewTradeRequest)(nil),        // 29: engine.api.OnNewTradeRequest
	(*OnNewTradeResponse)(nil),       // 30: engine.api.OnNewTradeResponse
	(*OnNewTokenRequest)(nil),        // 31: engine.api.OnNewTokenRequest
	(*OnNewTokenResponse)(nil),       // 32: engine.api.OnNewTokenResponse
	(*SearchTokenResult)(nil),        // 33: engine.api.SearchTokenResult
	(*SearchTokenResultList)(nil),    // 34: engine.api.SearchTokenResultList
	(*SearchTokenRequest)(nil),       // 35: engine.api.SearchTokenRequest
	(*SearchTokenResponse)(nil),      // 36: engine.api.SearchTokenResponse
	(*OnPairSyncRequest)(nil),        // 37: engine.api.OnPairSyncRequest
	(*OnPairSyncResponse)(nil),       // 38: engine.api.OnPairSyncResponse
	(*OnParseBlockTimeRequest)(nil),  // 39: engine.api.OnParseBlockTimeRequest
	(*OnParseBlockTimeResponse)(nil), // 40: engine.api.OnParseBlockTimeResponse
}
var file_engine_engine_proto_depIdxs = []int32{
	4,  // 0: engine.api.Hot.dex:type_name -> engine.api.Dex
	6,  // 1: engine.api.HotList.hot:type_name -> engine.api.Hot
	0,  // 2: engine.api.SubscribeHotResponse.status:type_name -> engine.api.InternalEngineStatus
	7,  // 3: engine.api.SubscribeHotResponse.hot_list:type_name -> engine.api.HotList
	5,  // 4: engine.api.SubscribeHotResponse.ping:type_name -> engine.api.Ping
	1,  // 5: engine.api.KLine.dimension:type_name -> engine.api.Dimension
	4,  // 6: engine.api.KLine.dex:type_name -> engine.api.Dex
	10, // 7: engine.api.KLineList.kline:type_name -> engine.api.KLine
	1,  // 8: engine.api.SubscribeKlineRequest.dimension:type_name -> engine.api.Dimension
	4,  // 9: engine.api.SubscribeKlineRequest.dex:type_name -> engine.api.Dex
	0,  // 10: engine.api.SubscribeKlineResponse.status:type_name -> engine.api.InternalEngineStatus
	11, // 11: engine.api.SubscribeKlineResponse.kline_list:type_name -> engine.api.KLineList
	5,  // 12: engine.api.SubscribeKlineResponse.ping:type_name -> engine.api.Ping
	4,  // 13: engine.api.Trade.dex:type_name -> engine.api.Dex
	14, // 14: engine.api.TradeList.trade:type_name -> engine.api.Trade
	4,  // 15: engine.api.SubscribeTradeRequest.dex:type_name -> engine.api.Dex
	0,  // 16: engine.api.SubscribeTradeResponse.status:type_name -> engine.api.InternalEngineStatus
	15, // 17: engine.api.SubscribeTradeResponse.trade_list:type_name -> engine.api.TradeList
	5,  // 18: engine.api.SubscribeTradeResponse.ping:type_name -> engine.api.Ping
	4,  // 19: engine.api.NewToken.dex:type_name -> engine.api.Dex
	18, // 20: engine.api.NewTokenList.new_token:type_name -> engine.api.NewToken
	0,  // 21: engine.api.SubscribeNewPairResponse.status:type_name -> engine.api.InternalEngineStatus
	19, // 22: engine.api.SubscribeNewPairResponse.new_token_list:type_name -> engine.api.NewTokenList
	5,  // 23: engine.api.SubscribeNewPairResponse.ping:type_name -> engine.api.Ping
	3,  // 24: engine.api.SubscribeNewPairResponse.operation:type_name -> engine.api.NewPairOperation
	0,  // 25: engine.api.GetNewPairResponse.status:type_name -> engine.api.InternalEngineStatus
	19, // 26: engine.api.GetNewPairResponse.new_token_list:type_name -> engine.api.NewTokenList
	4,  // 27: engine.api.GetKlineHistoryRequest.dex:type_name -> engine.api.Dex
	1,  // 28: engine.api.GetKlineHistoryRequest.dimension:type_name -> engine.api.Dimension
	0,  // 29: engine.api.GetKlineHistoryResponse.status:type_name -> engine.api.InternalEngineStatus
	11, // 30: engine.api.GetKlineHistoryResponse.kline_list:type_name -> engine.api.KLineList
	4,  // 31: engine.api.BasicInfo.dex:type_name -> engine.api.Dex
	4,  // 32: engine.api.GetBasicInfoRequest.dex:type_name -> engine.api.Dex
	0,  // 33: engine.api.GetBasicInfoResponse.status:type_name -> engine.api.InternalEngineStatus
	26, // 34: engine.api.GetBasicInfoResponse.basic_info:type_name -> engine.api.BasicInfo
	2,  // 35: engine.api.OnNewTradeRequest.direction:type_name -> engine.api.Direction
	4,  // 36: engine.api.OnNewTradeRequest.dex:type_name -> engine.api.Dex
	0,  // 37: engine.api.OnNewTradeResponse.status:type_name -> engine.api.InternalEngineStatus
	4,  // 38: engine.api.OnNewTokenRequest.dex:type_name -> engine.api.Dex
	0,  // 39: engine.api.OnNewTokenResponse.status:type_name -> engine.api.InternalEngineStatus
	4,  // 40: engine.api.SearchTokenResult.dex:type_name -> engine.api.Dex
	33, // 41: engine.api.SearchTokenResultList.results:type_name -> engine.api.SearchTokenResult
	0,  // 42: engine.api.SearchTokenResponse.status:type_name -> engine.api.InternalEngineStatus
	34, // 43: engine.api.SearchTokenResponse.result_list:type_name -> engine.api.SearchTokenResultList
	4,  // 44: engine.api.OnPairSyncRequest.dex:type_name -> engine.api.Dex
	0,  // 45: engine.api.OnPairSyncResponse.status:type_name -> engine.api.InternalEngineStatus
	0,  // 46: engine.api.OnParseBlockTimeResponse.status:type_name -> engine.api.InternalEngineStatus
	8,  // 47: engine.api.Engine.SubscribeHot:input_type -> engine.api.SubscribeHotRequest
	12, // 48: engine.api.Engine.SubscribeKline:input_type -> engine.api.SubscribeKlineRequest
	16, // 49: engine.api.Engine.SubscribeTrade:input_type -> engine.api.SubscribeTradeRequest
	20, // 50: engine.api.Engine.SubscribeNewPair:input_type -> engine.api.SubscribeNewPairRequest
	22, // 51: engine.api.Engine.GetNewPair:input_type -> engine.api.GetNewPairRequest
	35, // 52: engine.api.Engine.SearchToken:input_type -> engine.api.SearchTokenRequest
	24, // 53: engine.api.Engine.GetKlineHistory:input_type -> engine.api.GetKlineHistoryRequest
	27, // 54: engine.api.Engine.GetBasicInfo:input_type -> engine.api.GetBasicInfoRequest
	29, // 55: engine.api.Engine.OnNewTrade:input_type -> engine.api.OnNewTradeRequest
	31, // 56: engine.api.Engine.OnNewToken:input_type -> engine.api.OnNewTokenRequest
	37, // 57: engine.api.Engine.OnPairSync:input_type -> engine.api.OnPairSyncRequest
	39, // 58: engine.api.Engine.OnParseBlockTime:input_type -> engine.api.OnParseBlockTimeRequest
	9,  // 59: engine.api.Engine.SubscribeHot:output_type -> engine.api.SubscribeHotResponse
	13, // 60: engine.api.Engine.SubscribeKline:output_type -> engine.api.SubscribeKlineResponse
	17, // 61: engine.api.Engine.SubscribeTrade:output_type -> engine.api.SubscribeTradeResponse
	21, // 62: engine.api.Engine.SubscribeNewPair:output_type -> engine.api.SubscribeNewPairResponse
	23, // 63: engine.api.Engine.GetNewPair:output_type -> engine.api.GetNewPairResponse
	36, // 64: engine.api.Engine.SearchToken:output_type -> engine.api.SearchTokenResponse
	25, // 65: engine.api.Engine.GetKlineHistory:output_type -> engine.api.GetKlineHistoryResponse
	28, // 66: engine.api.Engine.GetBasicInfo:output_type -> engine.api.GetBasicInfoResponse
	30, // 67: engine.api.Engine.OnNewTrade:output_type -> engine.api.OnNewTradeResponse
	32, // 68: engine.api.Engine.OnNewToken:output_type -> engine.api.OnNewTokenResponse
	38, // 69: engine.api.Engine.OnPairSync:output_type -> engine.api.OnPairSyncResponse
	40, // 70: engine.api.Engine.OnParseBlockTime:output_type -> engine.api.OnParseBlockTimeResponse
...
func file_engine_engine_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_engine_engine_proto_msgTypes[33].Exporter = func(v interface{}, i int) interface{} {
		...
		file_engine_engine_proto_msgTypes[34].Exporter = func(v interface{}, i int) interface{} {
		...
		file_engine_engine_proto_msgTypes[35].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OnParseBlockTimeRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_engine_engine_proto_msgTypes[36].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OnParseBlockTimeResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
